...
void reset_arm_position(){
  ...
  /*--------------------- servo 0 ---------------------*/ 
  bas_servo.write(SERVO_0_HOME, 10, false);
  /*--------------------- servo 1 ---------------------*/ 
  shl_servo.write(SERVO_1_HOME, 10, false);
  /*--------------------- servo 2 ---------------------*/ 
  elb_servo.write(SERVO_2_HOME, 10, false);
  /*--------------------- servo 3 ---------------------*/ 
  wri_servo.write(SERVO_3_HOME, 10, false);
  /*--------------------- servo 4 ---------------------*/ 
  wro_servo.write(SERVO_4_HOME, 10, false);
  /*--------------------- servo 5 ---------------------*/ 
  gri_servo.write(SERVO_5_HOME, 10, false);
